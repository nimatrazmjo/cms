...
<?php
 ...
 echo form_open_multipart('pic/home/updateRecords/'.$id,$arr);
?>
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
        ...
        <td>
         <img src="<?=base_url()?>uploads/<?=$recordss['name']."".$recordss['ext']?>" width="100px" height="100px" alt="<?=$recordss['file_name']?>">
         <br/>
